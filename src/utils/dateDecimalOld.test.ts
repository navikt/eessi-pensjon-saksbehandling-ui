import { dateDecimalOld, isFloat, getFloatValues, writeFloat, sumValues, sumDates } from 'utils/dateDecimal'
...
describe('utils/dateDecimal', () => {
  ...
  it('dateDecimal: handles null/undefined', () => {
    expect(dateDecimalOld({ years: null, months: 3.5, days: undefined })).toEqual({
      days: 15, months: 3, years: 0
    })
  })

  it('dateDecimal: handles decimals', () => {
    expect(dateDecimalOld({ years: 5.25, months: 0, days: 0 })).toEqual({
      days: 0, months: 3, years: 5
    })
    expect(dateDecimalOld({ years: 0, months: 32.12, days: 0 })).toEqual({
      days: 4, months: 8, years: 2
    })
    expect(dateDecimalOld({ years: 1.5, months: 1.5, days: 1.5 })).toEqual({
      days: 17, months: 7, years: 1
    })
  })

  it('dateDecimal: outputs as string', () => {
    expect(dateDecimalOld({ years: 5.25, months: 0, days: 0 }, true)).toEqual({
      days: '', months: '3', years: '5'
    })
  })

  it('dateDecimal: handles trimesters', () => {
    expect(dateDecimalOld({ years: 0, months: 0, trimesters: 2.75, days: 0 })).toEqual({
      days: 8, months: 8, years: 0
    })
  })

  it('dateDecimal: handles mix of numbers and strings', () => {
    expect(dateDecimalOld({ years: '5.5', months: '1', days: 10 })).toEqual({
...
/*  it('dateDecimal: handles all values2', () => {
  ...
  it('dateDecimal: handles all values 3', () => {
    expect(dateDecimalOld({ days: '0', weeks: '200', months: '0', trimesters: '0', years: '0' })).toEqual({
      days: 8, months: 10, years: 3
    })
  })

  it('dateDecimal: handles all values 4', () => {
    expect(dateDecimalOld({ days: '0', weeks: '104', months: '0', trimesters: '0', years: '0' })).toEqual({
      days: 0, months: 0, years: 2
    })
  })

  it('dateDecimal: handles all values 5', () => {
    expect(dateDecimalOld({ days: '0', weeks: '5', months: '0', trimesters: '0', years: '0' })).toEqual({
      days: 5, months: 1, years: 0
    })
  })

  it('dateDecimal: handles all values 6', () => {
    expect(dateDecimalOld({ days: '0', weeks: '4', months: '0', trimesters: '0', years: '0' })).toEqual({
...
/*  it('dateDecimal: handles all values 6', () => {
    expect(dateDecimalOld({ days: '0', weeks: '-1', months: '0', trimesters: '0', years: '0' })).toEqual({
