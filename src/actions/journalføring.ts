...
export const getSed: ActionCreator<ThunkResult<ActionWithPayload<any>>> = (
  ...
  return call({
    url: sprintf(urls.JOURNALFØRING_SED_GET_URL, { aktoerId: aktoerId, sakId: sakId }),
...
export const jornalføreSed: ActionCreator<ActionWithPayload<any>> = (
  ...
  return call({
    url: sprintf(urls.JOURNALFØRING_SED_SEND_URL, { aktoerId: aktoerId, sakId: sakId, sedId: sedId }),
