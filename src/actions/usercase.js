...
export function getMottagerOptions () {
 return api.call({
   url: urls.MOTTAGER_URL,
   type: {
     request: types.USERCASE_GET_MOTTAGER_OPTIONS_REQUEST,
     success: types.USERCASE_GET_MOTTAGER_OPTIONS_SUCCESS,
     failure: types.USERCASE_GET_MOTTAGER_OPTIONS_FAILURE
   }
  });
}
