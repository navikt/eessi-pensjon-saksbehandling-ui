...
describe('Selenium PDF create', () => {
    ...
    describe('Front page', () => {
        ...
        it('Waiting until FrontPage loads...', async function () {
            ...
            link = await driver.findElement(By.css('.pdfLink'));
        ...
        it('Forwarding to select PDF page...', async function () {
    ...
    describe('Get select PDF page', () => {
        ...
        it('Waiting until selectPDF loads...', async function () {
            ...
            await driver.wait(until.elementLocated(By.css('.nav-fileUpload')));
            await driver.wait(until.elementLocated(By.css('button.forwardButton')));
            fileUpload = await driver.findElement(By.css('.nav-fileUpload .dropzone'));
