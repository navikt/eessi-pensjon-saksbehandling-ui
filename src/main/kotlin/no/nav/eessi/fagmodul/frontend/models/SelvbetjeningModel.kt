...
data class TrygdeTid (
        ...
        val trygdetidID: Long? = null,

        val periode: List<TrygdeTidPeriode>? = null,
...
data class TrygdeTidPeriode (
        val trygdetidperiodeID: Long? = null,
...
fun createTrygdeTidMock(): TrygdeTid {
