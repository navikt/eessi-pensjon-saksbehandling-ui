...
describe('applications/BUC/components/SEDP4000/Validation/singleTests', () => {
  it('stayAbroadValidation', () => {
    expect(singleTests.stayAbroadValidation).toEqual({})
  })
  ...
  it('periodValidation.periodType function', () => {
    let result = singleTests.periodValidation.periodType(undefined)
    expect(result).toEqual('pinfo:validation-noPeriodType')
    result = singleTests.periodValidation.periodType('mock')
    expect(result).toEqual('pinfo:validation-invalidPeriodType')
  ...
  it('periodValidation.insuranceName function', () => {
    let result = singleTests.periodValidation.insuranceName(undefined)
    expect(result).toEqual(undefined)
    ...
    expect(result).toEqual('pinfo:validation-wowMuchText')
    result = singleTests.periodValidation.insuranceName('something')
    expect(result).toEqual(undefined)
  })

  it('periodValidation.insuranceType function', () => {
    let result = singleTests.periodValidation.insuranceType(undefined)
    expect(result).toEqual(undefined)
  ...
  it('periodValidation.insuranceId function', () => {
    let result = singleTests.periodValidation.insuranceId(undefined)
    expect(result).toEqual(undefined)
  ...
  it('periodValidation.periodCountry function', () => {
    ...
    expect(result).toEqual('pinfo:validation-noCountry')
  ...
  it('periodValidation.periodPlace function', () => {
    ...
    expect(result).toEqual('pinfo:validation-noPlace')
  ...
  it('periodValidation.workActivity function', () => {
    let result = singleTests.periodValidation.workActivity(undefined)
    expect(result).toEqual('pinfo:validation-noWorkActivity')
  ...
  it('periodValidation.workName function', () => {
    let result = singleTests.periodValidation.workName(undefined)
    expect(result).toEqual(undefined)
  ...
  it('periodValidation.workPlace function', () => {
    let result = singleTests.periodValidation.workPlace(undefined)
    expect(result).toEqual(undefined)
  ...
  it('periodValidation.childFirstName function', () => {
    let result = singleTests.periodValidation.childFirstName(undefined)
    expect(result).toEqual('pinfo:validation-noChildFirstName')
    result = singleTests.periodValidation.childFirstName('123')
    expect(result).toEqual('pinfo:validation-invalidName')
  ...
  it('periodValidation.childLastName function', () => {
    let result = singleTests.periodValidation.childLastName(undefined)
    expect(result).toEqual('pinfo:validation-noChildLastName')
  ...
  it('periodValidation.learnInstitution function', () => {
    let result = singleTests.periodValidation.learnInstitution(undefined)
    expect(result).toEqual('pinfo:validation-noLearnInstitution')
  ...
  it('periodValidation.payingInstitution function', () => {
    let result = singleTests.periodValidation.payingInstitution(undefined)
    expect(result).toEqual('pinfo:validation-noPayingInstitution')
  ...
  it('periodValidation.otherType function', () => {
    let result = singleTests.periodValidation.otherType(undefined)
    expect(result).toEqual('pinfo:validation-noOtherType')
