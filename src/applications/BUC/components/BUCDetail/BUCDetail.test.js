...
describe('applications/BUC/components/BUCDetail/BUCDetail', () => {
  ...
  it('Has proper HTML structure', () => {
    ...
    expect(wrapper.find('#a-buc-c-bucdetail__props-creator-id').render().text()).toEqual(buc.creator.institution)
    ...
    expect(wrapper.find('.a-buc-c-bucdetail__institutions').hostNodes().render().text()).toEqual('NAVT000DEMO001DEMO002DEMO003DEMO004DEMO005')
  })
})
