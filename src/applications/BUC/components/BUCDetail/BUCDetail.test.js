...
describe('Renders without crashing', () => {
  ...
  it('Renders child components', () => {
    ...
    expect(wrapper.find('.a-buc-c-bucdetail__institutions').render()).toHaveLength(1)
    expect(wrapper.find('.a-buc-c-bucdetail__institutions').render().text()).toEqual('Norge: NO:NAVT003, NO:NAVT002')
  })
})
