...
describe('applications/BUC/components/BUCDetail/BUCDetail', () => {
  ...
  it('Has proper HTML structure', () => {
    ...
    expect(wrapper.find('#a-buc-c-bucdetail__props-type-id').render().text()).toEqual(buc.type)
    ...
    expect(wrapper.find('#a-buc-c-bucdetail__props-lastUpdate-id').render().text()).toEqual(moment(buc.lastUpdate).format('DD.MM.YYYY'))
