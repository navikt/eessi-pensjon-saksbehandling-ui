import { BRUKERKONTEKST, KRAVKONTEKST, VEDTAKSKONTEKST } from 'constants/constants'
...
describe('P_BUC_05 for SEDStart, brukerkontekst,', () => {
   ...
   */
  it('Scenario 1: Opprette P_BUC_05 - brukerkontekst', () => {
   ...
   */
  it('Opprette P_BUC_05 - brukerkontekst - etterlatteytelser (avdøde)', () => {
  ...
  /*
   EP 939
    ...
    OG saksbehandler kan bestille SED P8000
  */
  it('Scenario 3: Opprette P_BUC_05 - brukerkontekst -etterlatteyteser (bruker)', () => {
