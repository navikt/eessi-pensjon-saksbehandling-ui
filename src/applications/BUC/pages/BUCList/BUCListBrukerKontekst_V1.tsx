...
const BUCListBrukerKontekst_V1: React.FC<BUCListProps> = ({
  ...
  return (
    ...
    >
      ...
      {!_.isEmpty(bucs) && (sakType === SakTypeMap.GJENLEV || sakType === SakTypeMap.BARNEP) && (
            <>
              <VerticalSeparatorDiv size='2' />
              <BadBucDiv>
                <>
...
BUCListBrukerKontekst_V1.propTypes = {
  setMode: PT.func.isRequired
}

export default BUCListBrukerKontekst_V1
