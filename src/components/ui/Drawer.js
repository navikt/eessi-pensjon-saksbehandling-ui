       ...
       return <div id="wrapper" className={classNames({ toggled : this.state.toggled } )}>
           ...
           <div id="sidebar-wrapper"
               style={{backgroundColor: 'whitesmoke', width: this.state.width,
                   height: '100vh', position: 'sticky', top: 0, zIndex: 2, transition: 'width 0.2s ease-out'}}>
           ...
           <div id="page-content-wrapper" style={{paddingLeft: this.state.width, marginTop: '-100vh', transition: 'padding 0.2s ease-out'}}>
               {children}
           </div>
       </div>
   }
